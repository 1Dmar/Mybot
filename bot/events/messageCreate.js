    ...
    async execute(message) {
        ...
        if (/^mc\b/i.test(message.content)) {
            ...
            try {
                ...
                console.error("Error handling mc command:", error);
                await message.reply("<:Warning:1410147601281581118> An error occurred while processing the command");
            }
        }
    }
};
